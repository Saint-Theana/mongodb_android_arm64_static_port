...
int
res_search_d(const char *dname, int class, int type, unsigned char *answer, int anslen)
{
...
#define INIT_HANDLE(h) (res_init_d() == 0)
#define SEARCH(h, n, c, t, a, l) res_search_d(n, c, t, a, l)
