...
krb5_keyblock master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii;
krb5_principal master_princ_fahdufbufbfhfrkiii;
krb5_encrypt_block master_encblock;
krb5_pointer master_random;
char *str_master_princ_fahdufbufbfhfrkiii;
    ...
    char *argv[];
{
    ...
    while ((optchar = getopt(argc, argv, "D:P:p:n:d:r:R:k:M:e:m")) != -1) {
        ...
        case 'r':
            ...
            break;
        case 'k':
            master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype = atoi(optarg);
            enctypedone++;
            break;
    ...
    if (!enctypedone)
        master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype = DEFAULT_KDC_ENCTYPE;

    if (!krb5_c_valid_enctype(master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype)) {
        com_err(progname, KRB5_PROG_ETYPE_NOSUPP,
                "while setting up enctype %d", master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype);
        exit(1);
    }

    krb5_use_enctype(context, &master_encblock, master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype);
    ...
    memset(master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.contents, 0, (size_t) master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.length);
    if (retval && retval != KRB5_KDB_DBNOTINITED) {
        com_err(progname, retval, "while closing database");
        exit(1);
    }
    krb5_free_keyblock_contents(context, &master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii);

    if (str_master_princ_fahdufbufbfhfrkiii) {
        krb5_free_unparsed_name(context, str_master_princ_fahdufbufbfhfrkiii);
    }
    krb5_free_principal(context, master_princ_fahdufbufbfhfrkiii);
...
/*
  ...
  if (strcmp(str_mod_name, str_master_princ_fahdufbufbfhfrkiii) != 0) {
  fprintf(stderr, "\tmod name isn't the master princ (%s not %s).\n",
  str_mod_name, str_master_princ_fahdufbufbfhfrkiii);
  free(str_mod_name);
  goto errout;
  }
    ...
    char *dbname;
{
    ...
    if ((retval = krb5_db_setup_mkey_name(context, mkey_name, cur_realm, 0,
                                          &master_princ_fahdufbufbfhfrkiii))) {
    ...
    if (mkey_password) {
        ...
        retval = krb5_principal2salt(context, master_princ_fahdufbufbfhfrkiii, &scratch);
        if (retval) {
            com_err(pname, retval, "while calculated master key salt");
            return(1);
        }
        if ((retval = krb5_string_to_key(context, &master_encblock,
                                         &master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii, &pwd, &scratch))) {
        ...
        if ((retval = krb5_db_fetch_mkey(context, master_princ_fahdufbufbfhfrkiii,
                                         master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii.enctype,
                                         manual_mkey, FALSE, (char *) NULL,
                                         NULL, NULL,
                                         &master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii))) {
    ...
    if ((retval = krb5_db_fetch_mkey_list(context, master_princ_fahdufbufbfhfrkiii,
                                          &master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii))) {
        com_err(pname, retval, "while verifying master key");
        (void) krb5_db_fini(context);
        return(1);
    }
    if ((retval = krb5_db_get_principal(context, master_princ_fahdufbufbfhfrkiii, 0,
                                        &master_entry))) {
    ...
    if ((retval = krb5_unparse_name(context, master_princ_fahdufbufbfhfrkiii,
                                    &str_master_princ_fahdufbufbfhfrkiii))) {
    ...
    if ((retval = krb5_process_key(context,
                                   &master_encblock, &master_princ_fahdufbufbfhfrkiiihfydhehdb_farkiii))) {
